...
public class VentanaAsignarRepartidor extends JFrame {
    ...
    private JPanel RegistroRepartidor; // O RegistroRepartidor según cómo llamaste a tu JPanel
    ...
    public VentanaAsignarRepartidor(SistemaEntrega sistema) {
        ...
        setContentPane(RegistroRepartidor); // Usa la variable de tu JPanel principal
    ...
    private void asignarRepartidor() {
        String nombre = txtNombre.getText().trim(); // <--- Usar txtNombre
